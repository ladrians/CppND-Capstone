...
"""autogenerated by genpy from lsbot_msgs/Angle.msg. Do not edit."""
import codecs
import sys
...
class Angle(genpy.Message):
  _md5sum = "01acd77b6666d0b00354cd350705edbb"
  _type = "lsbot_msgs/Angle"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Reported angle by the Floorscan sensor
...
"""
  ...
  __slots__ = ['header','status','angle']
  _slot_types = ['std_msgs/Header','int16','float64']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_hd().pack(_x.status, _x.angle))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.status, _x.angle,) = _get_struct_hd().unpack(str[start:end])
      return self
